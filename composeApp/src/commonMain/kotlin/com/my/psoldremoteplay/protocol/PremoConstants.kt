...
object PremoConstants {
    ...
    // Platform-specific nonce XOR keys (from Ghidra — premo_plugin.elf)
    val NONCE_XOR_PSP = SKEY2 // PSP nonce key = skey2
    ...
    // Registration encryption keys (from Ghidra — sysconf_plugin.elf)
