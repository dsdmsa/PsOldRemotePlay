...
fun Ps3ControlPanel(
    ...
    Column(
        ...
        Button(
            onClick = { onIntent(Ps3Intent.DiscoverBroadcast) },
        ...
        OutlinedTextField(
            value = state.ps3Ip,
            onValueChange = { onIntent(Ps3Intent.UpdateIp(it)) },
        ...
        Button(
            onClick = { onIntent(Ps3Intent.DiscoverDirect(state.ps3Ip)) },
            modifier = Modifier.fillMaxWidth(),
        ...
        OutlinedTextField(
            value = state.pin,
            onValueChange = { onIntent(Ps3Intent.UpdatePin(it)) },
        ...
        Button(
            onClick = { onIntent(Ps3Intent.Register) },
            modifier = Modifier.fillMaxWidth(),
        ...
        OutlinedTextField(
            value = state.pkey,
            onValueChange = { onIntent(Ps3Intent.UpdatePkey(it)) },
        ...
        OutlinedTextField(
            ...
            onValueChange = { onIntent(Ps3Intent.UpdateDeviceId(it)) },
        ...
        OutlinedTextField(
            ...
            onValueChange = { onIntent(Ps3Intent.UpdateDeviceMac(it)) },
        ...
        if (state.isStreaming) {
            Button(
                onClick = { onIntent(Ps3Intent.Disconnect) },
                modifier = Modifier.fillMaxWidth(),
